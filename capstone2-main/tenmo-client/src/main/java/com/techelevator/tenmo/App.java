...
import com.techelevator.tenmo.Exception.InvalidTransferIdChoice;
import com.techelevator.tenmo.Exception.InvalidUserChoiceException;
...
public class App {
	...
	private static final String LOGIN_MENU_OPTION_REGISTER = "Enroll";
	private static final String LOGIN_MENU_OPTION_LOGIN = "Sign In";
	private static final String[] LOGIN_MENU_OPTIONS = {LOGIN_MENU_OPTION_REGISTER, LOGIN_MENU_OPTION_LOGIN, MENU_OPTION_EXIT};
	private static final String MAIN_MENU_OPTION_VIEW_BALANCE = "View Available Balance";
	private static final String MAIN_MENU_OPTION_SEND_BUCKS = "Send TE Bucks";
	private static final String MAIN_MENU_OPTION_VIEW_PAST_TRANSFERS = "Transfer History";
	private static final String MAIN_MENU_OPTION_REQUEST_BUCKS = "Request TE Bucks";
	private static final String MAIN_MENU_OPTION_VIEW_PENDING_REQUESTS = "Pending Transfer Requests";
	private static final String MAIN_MENU_OPTION_LOGIN = "Sign In as different user";
...
//		System.out.println("*********************");
		System.out.println("-----------------------------------------");
		System.out.println("                                         ");
		System.out.println("                TENMO CO.      ");
		System.out.println("         ONLINE PAYMENT SERVICE     ");
		System.out.println("            APP VERSION 1.2    ");
		System.out.println("                                         ");
		System.out.println("");
		System.out.println("      A NEW SAFE, FAST, AND FREE WAY ");
		System.out.println("            OF BANKING ONLINE");
		System.out.println("");
		System.out.println("-----------------------------------------");
